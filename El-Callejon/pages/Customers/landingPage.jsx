    ...
    <>
      <div className="Account">
        ...
        <div className="hero-section">
          ...
          <div className="custom-shape-divider-bottom-1748173865">
       ...
       <footer id="footer" style={{ position: 'relative', height: '80vh', color: 'black', fontFamily: 'sans-serif' }}>
        ...
        >
          ...
          <div className='D' style={{ fontSize: '17px', marginLeft: '100px', flex: '1' }}>
            <p style={{ marginBottom: '1rem', fontWeight: 'bold', textDecoration: 'underline' }}>Home</p>
            <Link to='/Customers-OrderNow' style={{ textDecoration: 'none', color: 'black' }}>
            <a style={{ marginBottom: '1rem' }}>Order Now</a></Link>
            <p className='Terms' style={{  marginTop: '10rem'}}>Terms & Conditons</p>
          </div>

          
          <div className='H' style={{marginLeft: '10px', flex: '2',  }}>
